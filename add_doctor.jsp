...
<div id="intro">
	<div class="width">
  	...
  	<fieldset>
               ...
               <p><label for="name">Hospitalid:</label>
                    <input type="text" name="hid" value="<%=regdno_var%>" onFocus="onFocusthis.blur()" id="hid"></p>
...
<p><label for="name">Doctor Name:</label>
 ...
 %>
		...
		<p><label for="Type">Type:</label>
           ...
           <p><label for="t_from">Time from:</label>
                    <input type="text" name="t_from" id="t_from"></p>
                 <p><label for="t_from">Time to:</label>
                    <input type="text" name="t_to" id="t_to"></p>
                 <p>
                 <p><input type="button" value="Add" onclick="submitForm()" />

<script>
	function submitForm()
	{		
		document.f1.action='add_doctor';
		document.f1.submit();		
	}
</script>
</p>
