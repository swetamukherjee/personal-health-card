         ...
         <%
          regdno_var1=(String)session.getAttribute("regdno");
             ...
             Connection conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","citzen","citzen");
              ...
              <tr>
                                     <td>Patient Id</td>
                                    <td><input type="text" name="patient_id" value="<%=regdno_var1%>" onfocus="this.blur()"></td>
                                </tr>
                                <tr>
                                    <td>Patient Name</td>
                                    <td><input type="text" name="patient_name" value="<%=patient_name_var%>" onfocus="this.blur()"></td>
                                </tr>
                                <tr>
                                    <td>Gender</td>
                                    <td><input type="text" name="sex" value="<%=gender_var%>" onfocus="this.blur()"></td>
                                </tr> 
                                <tr>
                                    <td>Marital Status</td> 
                                   <td><input type="text" name="marital_status" value="<%=marital_status_var%>" onfocus="this.blur()"></td>
                                </tr>
                            
                                    <tr> 
                                        <td>DOB</td>
                                        <td><input type="text" name="dob" value="<%=dob_var%>" onfocus="this.blur()"></td>
                                    </tr>
                                    <tr> 
                                        <td>Age</td>
                                        <td><input type="text" name="age" value="<%=age_var%>"  onfocus="this.blur()"></td>
                                    </tr>
                                    <tr> 
                                        <td>Address</td>
                                        <td><input type="text" name="address" value="<%=address_var%>"  onfocus="this.blur()"></td>
                                    </tr>
                                <tr> 
                                        <td>City</td>
                                        <td><input type="text" name="city" value="<%=city_var%>"  onfocus="this.blur()"></td>
                                    </tr>
                                  <tr> 
                                        <td>District</td>
                                        <td><input type="text" name="district" value="<%=district_var%>"  onfocus="this.blur()"></td>
                                    </tr>
                                    <tr> 
                                        <td>State</td>
                                        <td><input type="text" name="state" value="<%=state_var%>"  onfocus="this.blur()"></td>
                                    </tr>
                                    <tr> 
                                        <td>PIN</td>
                                        <td><input type="text" name="pin" value="<%=pin_var%>"  onfocus="this.blur()"></td>
                                    </tr>
                                    <tr> 
                                        <td>Phone No</td>
                                        <td><input type="text" name="phn_no" value="<%=phn_no_var%>"  onfocus="this.blur()"></td>
                                    </tr>
                                    <tr> 
                                        <td>Email</td>
                                        <td><input type="text" name="email" value="<%=email_var%>"  onfocus="this.blur()"></td>
                                    </tr>
                                    <tr> 
                                        <td>Complain</td>
                                        <td><input type="text" name="complain" value="<%=complain_var%>"  onfocus="this.blur()"></td>
                                    </tr>
                            </table>
     <div class="clear"></div>
    </div>       
